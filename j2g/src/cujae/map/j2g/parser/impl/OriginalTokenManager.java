/* Generated By:JavaCC: Do not edit this line. OriginalTokenManager.java */
...
public class OriginalTokenManager implements OriginalConstants
{
  int parentCount;
...
/** Constructor. */
public OriginalTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public OriginalTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
