/* Generated By:JavaCC: Do not edit this line. TkSolverTokenManager.java */
...
public class TkSolverTokenManager implements TkSolverConstants
{
  int parentCount;
...
/** Constructor. */
public TkSolverTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public TkSolverTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
   ...
   switch(jjmatchedKind)
   {
      ...
      case 27 :
        ...
        lengthOfMatch = jjstrLiteralImages[27].length();
                        if(parentCount == 0) SwitchTo(EndComment0);
         break;
      default :
         break;
   }
